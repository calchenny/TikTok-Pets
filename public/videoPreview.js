...
// grab elements
let reloadIcon = document.getElementById("icon");
let divElmt = document.getElementById("tiktokDiv");
let vidTitle = document.getElementById("vidTitle");


// set up clickable icon
reloadIcon.addEventListener("click", reloadVideo);
...
sendGetRequest('/getMostRecent') 
  .then(function(result) {
    ...
    sessionStorage.setItem("mostRecentURL", jsonObject.url);
    // get the nickname
    vidTitle.textContent = jsonObject.nickname;
    addVideo(sessionStorage.getItem("mostRecentURL"), divElmt);
    loadTheVideos();
  })
